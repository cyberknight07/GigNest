...
export const createGig = async (req,res, next) => {
    if(!req.isSeller) return next(createError(403, "Only seller can create gigs."));
...
export const deleteGig = async (req, res, next) => {
    try{
        ...
        if(gig.userId != req.userId){
            return next(createError(403, "You are not authorized to delete this gig. DELETE GIG"))
        }
